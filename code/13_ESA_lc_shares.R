...
basins <- st_make_valid(st_read(p("processed/basins/relevant_basins-ipis.gpkg")))
...
saveRDS(lc_summarised, file = p("processed/CCI_lc_summarised.RDS"))
